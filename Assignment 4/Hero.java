...
public abstract class Hero {
    ...
    public void showItems() {
        ...
        if (equips.isEmpty()) {
            System.out.println(LMaH.ANSI_RED + "You have no equipment!" + LMaH.ANSI_RESET);
        } else {
    ...
    public void consumePotion() {
        ...
        if (potions.isEmpty()) {
            System.out.println(LMaH.ANSI_RED + "You have no potion!" + LMaH.ANSI_RESET);
        } else {
            System.out.println(LMaH.ANSI_CYAN + "Choose one potion to use:" + potions + LMaH.ANSI_RESET);
    ...
    public Spell chooseSpell() {
        ...
        if (spells.isEmpty()) {
            System.out.println(LMaH.ANSI_RED + "You have no spell!" + LMaH.ANSI_RESET);
            return null;
        } else {
            System.out.println(LMaH.ANSI_CYAN + "Choose one spell to use:" + spells + LMaH.ANSI_RESET);
            Scanner sc = new Scanner(System.in);
            int option = sc.nextInt();
    ...
    public void changeEquipment() {
        ...
        if (weaponarmors.isEmpty()) {
            System.out.println(LMaH.ANSI_RED + "You have no equipment left!" + LMaH.ANSI_RESET);
        } else {
            System.out.println(LMaH.ANSI_CYAN + "Choose one to use:" + weaponarmors + LMaH.ANSI_RESET);
            Scanner sc = new Scanner(System.in);
            int option = sc.nextInt();
...
class Warrior extends Hero {
    ...
    public String toString() {
        return "(Warrior) " + name + ", Lv: " + level + ", HP: " + hpLeft + "/" + hp + ", Mana: " + manaLeft + "/" +
                mana + ", Exp: " + exp + ", Coins: " + coins + ", Strength: " + strength + ", Dexterity: " + dexterity +
                ", Agility: " + agility + ", weapon: " + weaponEquipped + ", armor: " + armorEquipped + "\n";
    }
}
...
class Sorcerer extends Hero {
    ...
    @Override
    public String toString() {
        return "(Sorcerer) " + name + ", Lv: " + level + ", HP: " + hpLeft + "/" + hp + ", Mana: " + manaLeft + "/" +
                mana + ", Exp: " + exp + ", Coins: " + coins + ", Strength: " + strength + ", Dexterity: " + dexterity +
                ", Agility: " + agility + ", weapon: " + weaponEquipped + ", armor: " + armorEquipped + "\n";
    }
}
...
class Paladin extends Hero {
    ...
    @Override
    public String toString() {
        return "(Paladin) " + name + ", Lv: " + level + ", HP: " + hpLeft + "/" + hp + ", Mana: " + manaLeft + "/" +
                mana + ", Exp: " + exp + ", Coins: " + coins + ", Strength: " + strength + ", Dexterity: " + dexterity +
                ", Agility: " + agility + ", weapon: " + weaponEquipped + ", armor: " + armorEquipped + "\n";
    }
}
