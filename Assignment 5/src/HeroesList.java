...
public class HeroesList {
    public static List<Warrior> warriors = new ArrayList<>();
    public static List<Sorcerer> sorcerers = new ArrayList<>();
    public static List<Paladin> paladins = new ArrayList<>();

    public HeroesList() {
        // warriors
        File file = new File(LoV.warriors);
        try {
